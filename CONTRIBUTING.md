...
issue](https://github.com/cisagov/cool-master-wiz/issues) in this
...
request](https://github.com/cisagov/cool-master-wiz/pulls), you
...
```console
cd cool-master-wiz
pyenv virtualenv <python_version_to_use> cool-master-wiz
pyenv local cool-master-wiz
